...
export const InputPostBoxForm = () => {
  ...
  const DefaultInputStyle =
    "pl-2 h-[2rem] w-[100%] border-2 border-black rounded-xl focus:bg-purple-300 placeholder-purple-600 placeholder-opacity-50";
  const DefaultContainerStyle =
    "grid grid-cols-4 col-span-4 flex justify-center items-center";
  return (
      ...
      <div className="grid grid-cols-4 gap-y-3">
        <div className={DefaultContainerStyle}>
          ...
          <div className="col-span-3">
            <input
              ...
              {...register("title")}
              onChange={(e) =>
                setSamplePost((val) => ({ ...val, title: e.target.value }))
              }
            />
          </div>
        </div>
        ...
        <div className={DefaultContainerStyle}>
          ...
          <div className="col-span-3">
            <input
              ...
              {...register("heading")}
              onChange={(e) =>
                setSamplePost((val) => ({ ...val, heading: e.target.value }))
              }
            />
          </div>
        </div>
        ...
        <div className="col-span-4 flex justify-around">
          <div>
            <input
              ...
              id="link"
              onClick={(e) => {
                setSamplePost((val) => ({ ...val, typeLink: "link" }));
              }}
            />
          ...
          <div>
            ...
            <label
              htmlFor="youtube"
              onClick={(e) => {
                setSamplePost((val) => ({ ...val, typeLink: "youtube" }));
              }}
            >
              Youtube
            </label>
          ...
          <div>
            <input
              ...
              id="twitter"
              onClick={(e) => {
                setSamplePost((val) => ({ ...val, typeLink: "twitter" }));
              }}
            />
          ...
          <div>
            <input
              ...
              id="instagram"
              onClick={(e) => {
                setSamplePost((val) => ({ ...val, typeLink: "instagram" }));
              }}
            />
          ...
          <div>
            <input
              ...
              id="normalPost"
              onClick={(e) => {
                setSamplePost((val) => ({ ...val, typeLink: "normalPost" }));
              }}
            />
            ...
            <div className={DefaultContainerStyle}>
              ...
              <div className="col-span-3">
                <input
                  ...
                  {...register("link")}
                  onChange={(e) =>
                    setSamplePost((val) => ({ ...val, link: e.target.value }))
                  }
                />
              </div>
            </div>
            ...
            <div className="col-span-3">
              <input
                ...
                onChange={(e) =>
                  setSamplePost((val) => ({
                    ...val,
                    link: convertToEmbedUrl(e.target.value),
                  }))
                }
              />
            </div>
        ...
        <div className="col-span-4">
          <textarea
            ...
            {...register("textAbout")}
            onChange={(e) =>
              setSamplePost((val) => ({ ...val, textAbout: e.target.value }))
            }
          />
        </div>
