...
export const SignInComponent = () => {
  ...
  const handleFormSubmit = async (e: SignInType) => {
    try {
      const data = await fetch(`${BACKEND_URL}/api/v1/signin`, {
        method: "POST",
        credentials: "include",
        headers: {
  ...
  return (
    <div className="flex justify-center items-center border-solid bg-white border-black border-2 w-[35%] h-[90%] rounded-lg">
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            <div className="flex flex-col justify-around  h-[200px]">
              <div>
                ...
                <input
                  className="w-[59%] border-2 border-black rounded-xl pl-1 py-1"
                  {...register("username")}
                  required={true}
                />
              </div>
              ...
              <div>
                ...
                <input
                  className="w-[60%] border-2 border-black rounded-xl pl-1 py-1"
                  type="password"
                  {...register("password")}
                  required={true}
                />
              ...
              <div className="flex items-center">
                <input
                  className="mr-1 h-[20px] border-2 border-black"
                  type="checkbox"
                  {...register("rememberMe")}
                />
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  varient={isSubmitting ? "disabled" : "default"}
