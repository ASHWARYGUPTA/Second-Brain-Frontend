...
export const SignUpComponent = () => {
  ...
  const validateEmail = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (!e.target.value.includes("@")) {
      ...
      await setTimeout(async () => {
        ...
        const res = await fetch(`${BACKEND_URL}/api/v1/signin/findEmail`, {
          method: "GET",
          headers: {
  ...
  const validateUsername = async (e: React.ChangeEvent<HTMLInputElement>) => {
    await setTimeout(async () => {
      const data = await fetch(`${BACKEND_URL}/api/v1/signin/findUser`, {
        method: "GET",
        headers: {
          user: e.target.value,
        },
  ...
  return (
    <div className="flex justify-center items-center border-solid bg-white border-black border-2 w-[35%] h-[95%] rounded-lg">
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            <div className="flex flex-col justify-around  h-[200px]">
              <div className="my-1">
                ...
                <input
                  className="ml-1 w-[65%] border-2 border-black rounded-xl pl-1 py-1 placeholder-slate-500"
                  type="text"
                  placeholder="Name"
                  {...register("name")}
                />
              ...
              <div className="my-1">
                ...
                <input
                  className="w-[59%] border-2 border-black rounded-xl pl-1 py-1 placeholder-slate-500 "
              ...
              <div className="my-1">
                ...
                <input
                  className="ml-1 w-[60%] border-2 border-black rounded-xl pl-1 py-1 placeholder-slate-500"
                  type="password"
              ...
              <div className="mt-1">
                ...
                <span>
                  <input
                    className="ml-1 w-[20%] border-2 border-black rounded-xl pl-1 py-1 placeholder-slate-500"
                    type="Number"
                    placeholder="Age"
                    {...register("age")}
                    onChange={(e) => {
              ...
              <div className="flex justify-center mt-4">
                <Button
                  ...
                  varient={
                    !isCorrectValue || isSubmitting ? "disabled" : "default"
                  }
