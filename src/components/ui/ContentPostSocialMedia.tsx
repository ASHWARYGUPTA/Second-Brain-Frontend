...
interface ContentPostSocialMediaType{
    typeLink:string;
    text?:string;
    link?:string;
    title?:string;
...
export const ContentPostSocialMedia = (props:ContentPostSocialMediaType)=>{
        ...
        return (
            <div className={`${DefaultStyles} ${ContentPostVarientUse[props.varient?props.varient:"normal"]}`}>
                ...
                <div className="h-[450px] py-4 flex-wrap overflow-scroll">
                    <InstagramEmbed url="https://www.instagram.com/shitindianssay/reel/DDMnUaANvxs/" captioned/>
                </div>
